...
function LotesMedicamento($IdFarmacia,$Medicina){
if($IdFarmacia==0){
...
function SumatoriaMedicamento($IdFarmacia,$IdArea,$IdMedicina,$FechaInicio,$FechaFin){

if($IdFarmacia!=0){$comp=" and IdFarmacia=".$IdFarmacia;}else{$comp="";}
if($IdArea!=0){$comp2="and IdAreaOrigen=".$IdArea;}else{$comp2="";}
...
function Insatisfecha($IdFarmacia,$IdArea,$IdMedicina,$FechaInicio,$FechaFin){

if($IdFarmacia!=0){$comp=" and fr.IdFarmacia=".$IdFarmacia;}else{$comp="";}
if($IdArea!=0){$comp2="and fr.IdArea=".$IdArea;}else{$comp2="";}
