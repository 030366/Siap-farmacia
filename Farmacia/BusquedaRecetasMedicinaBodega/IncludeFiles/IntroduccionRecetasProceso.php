...
case 1:
 ...
 if(($respCierre[0]!=NULL and $respCierre[0]!='') || ($respCierreMes[0]!=NULL and $respCierreMes[0]!='')){
	...
	$resp=$proceso->ObtenerRecetas($IdMedicina,$IdFarmacia,$IdArea,$IdSubEspecialidad,$IdEmpleado,$FechaInicial,$FechaFinal,$_SESSION["TipoFarmacia"]);
...
case 2:
	...
	$resp=$proceso->DetalleReceta($IdReceta);
	$tabla='
	<table width="100%">
	<tr class="FONDO2">
...
case 8:
	...
	$proceso->GuardarNuevaMedicina($IdReceta,$IdMedicina,$Cantidad);	
