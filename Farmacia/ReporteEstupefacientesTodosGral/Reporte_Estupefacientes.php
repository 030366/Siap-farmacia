...
//******************************* QUERIES Y RECORRIDOS
	...
	<tr class="MYTABLE"><td align="right" colspan="11">Fecha de Emisi&oacute;n: ' . $DateNow = date("d-m-Y") . '
                ...
                $nombreTera = NombreTera($IdGrupoTerapeutico, $FechaInicio, $FechaFin, $IdFarmacia);
		...
		&nbsp;<strong>' . $NombreTerapeutico . '</strong></td>
			...
			<tr class="FONDO2">
			  ...
			  <th width="136" scope="col">Monto[$]</th>
                        ...
                        $resp1 = QueryExterna($IdTerapeutico, $IdMedicina, $FechaInicio, $FechaFin, $IdFarmacia);
                        while ($row = mysql_fetch_array($resp1)) {
                            ...
                            $respuesta = ObtenerReporteGrupoTerapeutico($IdTerapeutico, $Medicina, $FechaInicio, $FechaFin);
                            ...
                            if ($row2 = mysql_fetch_array($respuesta)) { /* verificacion de datos */
                                ...
                                $sat = ObtenerRecetasSatisfechas($IdReceta, $Medicina, $FechaInicio, $FechaFin, $IdFarmacia);
                                $insat = ObtenerRecetasInsatisfechas($IdReceta, $Medicina, $FechaInicio, $FechaFin, $IdFarmacia);
                                $Nrecetas = $sat + $insat;
                                //***********
                                //***********
                                /*
                                ...
                                $respSum = SumatoriaMedicamento($Medicina, $FechaInicio, $FechaFin,$IdFarmacia);
