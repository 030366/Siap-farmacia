...
function NombreTera($grupoTerapeutico, $FechaInicio, $FechaFin, $IdFarmacia) {
...
function QueryExterna($IdTerapeutico, $IdMedicina, $FechaInicio, $FechaFin, $IdFarmacia) {
...
function ObtenerReporteGrupoTerapeutico($GrupoTerapeutico, $IdMedicina, $FechaInicio, $FechaFin) {
...
function ObtenerRecetasSatisfechas($IdReceta, $IdMedicina, $FechaInicio, $FechaFin, $IdFarmacia) {
...
//satisfechas
//Para Insatisfechas
function ObtenerRecetasInsatisfechas($IdReceta, $IdMedicina, $FechaInicio, $FechaFin, $IdFarmacia) {
...
function SumatoriaMedicamento($IdMedicina, $FechaInicio, $FechaFin, $IdFarmacia) {
