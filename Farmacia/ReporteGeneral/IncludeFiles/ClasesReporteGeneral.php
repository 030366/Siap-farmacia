...
function ObtenerRecetasFarmacia($IdSubEspecialidad,$FechaInicial,$FechaFinal){
		...
		$query="select 
				...
				group by sec_historial_clinico.IdSubServicio, farm_recetas.IdFarmacia
				order by CodigoFarmacia";
...
function ObtenerNumeroRecetasFarmacia($IdSubEspecialidad,$FechaInicial,$FechaFinal){
