...
case 13:
	/*MOSTRAR SUBESPECIALIDADES O SERVICIO ORIGEN DE RECETA*/
		...
		$query="select mnt_subservicio.IdSubServicio,NombreSubServicio, IdServicio  as Ubicacion
...
case 16:
	$IdMedicina=$_GET["IdMedicina"];
	$IdArea=$_GET["IdArea"];
	echo $proceso->ObtenerExistencia($IdMedicina,$IdArea,$_SESSION["IdEstablecimiento"]);
