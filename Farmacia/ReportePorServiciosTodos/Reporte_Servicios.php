...
if(isset($_GET["IdSubServicio"])){$IdSubEspecialidad=$_GET["IdSubServicio"];}else{$IdSubEspecialidad=0;}
...
$respServicios=Servicios($IdSubEspecialidad,$IdGrupoTerapeutico,$IdMedicina,$FechaInicio,$FechaFin,$IdFarmacia);
...
do{
	...
	$nombreTera=NombreTera($IdGrupoTerapeutico,$IdSubEspecialidad,$FechaInicio,$FechaFin,$IdFarmacia);
	...
	do{
		...
		$resp1=QueryExterna($IdTerapeutico,$IdMedicina,$IdSubEspecialidad,$FechaInicio,$FechaFin,$IdFarmacia);
		...
		$sat=ObtenerRecetasSatisfechas($IdReceta,$Medicina,$FechaInicio,$FechaFin,$IdSubEspecialidad,0,0,$IdFarmacia);
		$insat=ObtenerRecetasInsatisfechas($IdReceta,$Medicina,$FechaInicio,$FechaFin,$IdSubEspecialidad,0,0,$IdFarmacia);
			$Nrecetas=$sat+$insat;
		//***********
	...
	*/
		...
		$respSum=SumatoriaMedicamento($Medicina,$IdSubEspecialidad,$FechaInicio,$FechaFin,$IdFarmacia);
