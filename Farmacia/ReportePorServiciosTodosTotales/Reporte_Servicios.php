...
$respServicios=Servicios($IdSubEspecialidad,$IdGrupoTerapeutico,$IdMedicina,$FechaInicio,$FechaFin);
...
do{
	...
	*/
		...
		$respSum=SumatoriaMedicamento($Medicina,$IdSubEspecialidad,$FechaInicio,$FechaFin);
    ...
    $reporte2.='<tr class="FONDO2" style="background:#CCCCCC;">
      <td align="right"><strong>'.strtoupper($NombreSubEspecialidad).':</strong></td>
