	...
	if($grupos=mysql_fetch_array($nombreTera)){
		...
		$respuesta=ObtenerReporteGrupoTerapeutico($IdTerapeutico,$Medicina,$FechaInicio,$FechaFin,$IdSubEspecialidad);
		    ...
		    if($row2=mysql_fetch_array($respuesta)){ /* verificacion de datos */
		        ...
		        $sat=ObtenerRecetasSatisfechas($Medicina,$FechaInicio,$FechaFin,$IdSubEspecialidad,0,0,$IdFarmacia);
		        $insat=ObtenerRecetasInsatisfechas($Medicina,$FechaInicio,$FechaFin,$IdSubEspecialidad,0,0,$IdFarmacia);
		        	$Nrecetas=$sat+$insat; 
		        //***********
